...
1. **“Obvious” Next Steps**
	...
	2. **Enhanced Preprocessing:**
    		* **Multi-scale Analysis:** Detecting circular structures at varying scales and orientations could mitigate issues arising from varying map resolutions or inconsistently drawn features. This step could help reduce false negatives and improve recall. The authors acknowledge class imbalance as a significant challenge, with only 335 positive cases (MGP sites) compared to 6,384 negatives in the dataset. They partially address this by oversampling positive cases using SMOTE:
		> "Imblearn generates new minority case data... this approach reduced the ratio of minority to majority cases from 1:20 to 1.25:20."
